...
2. Next, you'll want to configure your site i18n setup (one language, or multiple). Follow instructions in the [i18n documentation](https://cosmicthemes.com/docs/i18n/).
...
The source files have the following general structure. Note that not all files are included - it is already long, no one wants it to be longer.
